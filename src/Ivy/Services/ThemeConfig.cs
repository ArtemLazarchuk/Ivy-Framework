...
public class ThemeColors
{
    ...
    {
        Primary = IvyFrameworkChromaticTokens.Color.Pink,
        PrimaryForeground = IvyFrameworkChromaticTokens.Color.PinkForeground,
        ...
        Ring = IvyFrameworkChromaticTokens.Color.Pink,
        ...
        IvyGreen = IvyFrameworkChromaticTokens.Color.Pink,
        IvyGreenForeground = IvyFrameworkChromaticTokens.Color.PinkForeground
    };
