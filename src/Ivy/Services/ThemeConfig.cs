...
public class ThemeColors
{
    ...
    {
        Primary = IvyFrameworkChromaticTokens.Color.Sky,
        PrimaryForeground = IvyFrameworkChromaticTokens.Color.SkyForeground,
        ...
        Ring = IvyFrameworkChromaticTokens.Color.Sky,
        ...
        IvyGreen = IvyFrameworkChromaticTokens.Color.Sky,
        IvyGreenForeground = IvyFrameworkChromaticTokens.Color.SkyForeground
    };
